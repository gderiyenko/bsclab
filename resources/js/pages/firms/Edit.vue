<template>
    <div class="container">
        ...
        <div class="py-5 text-center">
            <h4>Редагування інформації про контрагента</h4>
        </div>

        <div class="row">
            <div class="col-md-12">
                <form @submit.prevent="firmUpdate">
                    ...
                    <div>
                        ...
                        <router-link :to="{name: 'firms.show', params: { id: firm.id }}"
...
export default {
    ...
    created() {
        this.axios
            .get(process.env.MIX_APP_URL + '/api/firms/edit/' + `${this.$route.params.id}`)
            .then((response) => {
    ...
    methods: {
        ...
        firmUpdate() {
            this.axios
                .post(process.env.MIX_APP_URL + '/api/firms/update/' + `${this.$route.params.id}`, this.firm)
                .then((response) => {
                    this.$router.push({name: 'firms.show', params: {id: this.firm.id}})
                })
                .catch(error => {
