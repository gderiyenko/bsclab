<template>
    <div class="container">
        ...
        <div class="py-5 text-center">
            <h4>Редагування договору</h4>
        </div>

        <div class="row">
            <div class="col-md-12">

                <form @submit.prevent="contractUpdate">
...
export default {
    ...
    created() {
        this.axios
            .get(process.env.MIX_APP_URL + '/api/contracts/edit/' + `${this.$route.params.id}`)
            .then((response) => {
    ...
    methods: {
        contractUpdate() {
            this.axios
                .post(process.env.MIX_APP_URL + '/api/contracts/update/' + `${this.$route.params.id}`, this.contract)
                .then((response) => {
